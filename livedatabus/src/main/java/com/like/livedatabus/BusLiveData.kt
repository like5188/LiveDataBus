 ...
 * ①、看看LiveData的observe方法，他会创建一个LifecycleBoundObserver，LifecycleBoundObserver是ObserverWrapper的派生类。
 ...
 * ②、对于非生命周期感知的observeForever方法来说，实现的思路是一致的，但是具体的实现略有不同。
 * observeForever的时候，生成的wrapper不是LifecycleBoundObserver，而是AlwaysActiveObserver，
